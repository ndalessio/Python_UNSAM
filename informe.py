...
def balance(nombre_archivo1,nombre_archivo2):
	...
	if pago_prod > valor_mercado:
		...
		res = 'ganancia'
	return (print(f'El pago al productor fue de : ${pago_prod:0.2f}, el valor del mercado del camion es de : ${valor_mercado:0.2f}. El balance de la operacion fue de: ${valor_mercado-pago_prod:0.2f} de {res}'))
